...
nohup ./build/server b --name=S1 --port=50051 --peers=localhost:50052,localhost:50053 &
nohup ./build/server b --name=S2 --port=50052 --peers=localhost:50051,localhost:50053 &
nohup ./build/server b --name=S3 --port=50053 --peers=localhost:50051,localhost:50052 &
